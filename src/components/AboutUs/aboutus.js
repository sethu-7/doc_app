...
const AboutUs = () => {
  return (
    <div style={{ marginLeft: '30px', marginRight: '30px', marginTop: '30px' }}>
      ...
      <Section title="Health is a habit">
        <p>
      ...
      <Section title="Data privacy and security is our top priority">
        <img src="https://www.Practo.com/providers/static/images/pages/company/about/security.png" alt="Security" />
        <p>
          Data privacy and security has always served as one of the founding philosophies of Opiherbs, and we go to great lengths to safeguard the confidentiality and integrity of our users.
        </p>
      </Section>

      <Section title="Our investors share our vision">
        <p>
